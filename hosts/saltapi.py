...
class SaltAPI(object):
    ...
    def remote_noarg_execution1(self, tgt, arg, arg1):
...
def main():
    ...
    #print os_release
    #print os_all
    #jid = SALTAPI.remote_noarg_execution1('monitor1,salt-client.localdomain','cp.get_file','salt://apache/script/install.sh  /tmp/install.sh')
    #print jid
    #jid = sapi.salt_mod('monitor,monitor','cp.get_file',['salt://apache/script/install.sh','/tmp/install.sh'])
    #print jid
    jid = SALTAPI.shell_remote_execution('monitor','uptime')
    print jid
